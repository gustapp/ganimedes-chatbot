""" Load Dictionaries: 
    ...
    * entity2id
"""
entity2id_path = 'functions/src/model/kb/OpenKE/benchmarks/USPedia/entity2id.txt'
relation2id_path = 'functions/src/model/kb/OpenKE/benchmarks/USPedia/relation2id.txt'
...
import pickle
with open('functions/src/artifacts/dicts/entity2id.pkl', 'wb') as output:  # Overwrites any existing file.
    pickle.dump(entity2id, output, pickle.HIGHEST_PROTOCOL)
with open('functions/src/artifacts/dicts/id2entity.pkl', 'wb') as output:  # Overwrites any existing file.
    pickle.dump(id2entity, output, pickle.HIGHEST_PROTOCOL)
with open('functions/src/artifacts/dicts/relation2id.pkl', 'wb') as output:  # Overwrites any existing file.
